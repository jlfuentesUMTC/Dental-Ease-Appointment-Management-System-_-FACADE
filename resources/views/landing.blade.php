    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-12">
                <a href="#features" class="text-xs font-bold uppercase tracking-[0.2em] text-gray-500 hover:text-cyan-600 transition-colors font-display">Services</a>
                <a href="#pricing" class="text-xs font-bold uppercase tracking-[0.2em] text-gray-500 hover:text-cyan-600 transition-colors font-display">Pricing</a>
                <a href="#contact" class="text-xs font-bold uppercase tracking-[0.2em] text-gray-500 hover:text-cyan-600 transition-colors font-display">Contact</a>
            </div>
