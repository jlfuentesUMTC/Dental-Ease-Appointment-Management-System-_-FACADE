    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center gap-1">
            ...
            <a href="{{ route('clinic.profile') }}"
                class="flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all {{ request()->routeIs('clinic.profile*') ? 'bg-cyan-500 text-white shadow-lg shadow-cyan-100' : 'text-slate-400 hover:text-slate-900 hover:bg-slate-50' }}">
        ...
        <div class="flex items-center gap-3 sm:gap-4">
            ...
            <details class="relative group">
                <summary class="list-none cursor-pointer relative p-2 text-slate-400 hover:text-cyan-500 transition-colors">
                    ...
                    <span data-notification-count class="{{ $unreadCount > 0 ? '' : 'hidden' }} absolute top-1 right-1 min-w-4 h-4 px-1 bg-red-500 text-white text-[8px] font-black rounded-full border-2 border-white flex items-center justify-center">{{ $unreadCount }}</span>
                </summary>
                <div class="fixed left-3 right-3 top-20 max-h-[calc(100vh-6rem)] bg-white border border-slate-100 rounded-2xl shadow-2xl overflow-hidden z-50 sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-3 sm:w-80 sm:max-w-[calc(100vw-2rem)]">
                    ...
                    <div class="max-h-[60vh] sm:max-h-80 overflow-y-auto" data-notification-list data-notification-href="{{ route('clinic.appointments') }}">
